...
/**
 * create_space - function that allocates 1024
 * bytes for a buffer
 *
 * @file:the name of the file where characters
 * are stored
 *
 ...
 * @argv:an array of pointers to the the arguments
 *
 * Return:0 on success
 *
 * Description:if argument code is incorrect - exit code 97
 * incase file_from does not exists or can't be read - exit code 98
...
int main(int argc, char *argv[])
{
	...
	to = open(argv[2], O_CREAT | O_WRONLY | O_TRUNC, 06644);
